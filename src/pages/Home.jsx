  ...
  return (
    <PageWrapper>
      <div className='flex justify-center items-center flex-col px-6 md:px-4 mt-20'>
        ...
        <TypingHero />
        <button className='cursor-pointer bg-gradient-to-r from-[#01CFC9] to-[#0ea5e9] text-textlight md:text-lg h-16 w-64 rounded-xl shadow-[0_0_20px_rgba(1,207,201,0.6)]
