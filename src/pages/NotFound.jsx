  ...
  return (
    <PageWrapper>
     <div className='flex flex-col justify-center items-center p-10'>
        ...
        <Link to ="/"><button className='cursor-pointer bg-primary mt-20 h-[40px] w-[100px] md:h-[60px] md:w-[150px] rounded-md text-textlight text-sm md:text-md font-bold'>Go to Home</button></Link>
     </div>
    </PageWrapper>
  )
}
