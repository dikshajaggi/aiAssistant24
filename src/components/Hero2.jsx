...
const Hero2 = () => {
  return (
    <div className="mb-30 bg-[#ffe0e9] bg-[radial-gradient(circle,rgba(255,237,243,1)_10%,rgba(220,238,252,1)_100%)] w-[97%] rounded-2xl relative overflow-hidden flex flex-col justify-center items-center text-center px-6 md:px-16 py-16">
        ...
        <span className="font-extrabold text-secondary1">
  ...
  return (
    <div className='flex flex-col gap-4 justify-evenly items-start w-[70%] mt-16 mb-26 h-[50%]'>
      <div className='flex justify-between items-stretch '>
       <div className='drop-shadow-[0_10px_10px_rgba(0,0,0,0.2)] flex flex-col items-start gap-2 bg-[#faf7ff] bg-[linear-gradient(0deg,rgba(250,247,255,1)_40%,rgba(243,224,255,0.3)_60%)] rounded-2xl p-6 w-[46%]'>
        ...
        <div className='flex flex-col gap-6 w-[50%]'>
          <div className='drop-shadow-[0_10px_10px_rgba(0,0,0,0.2)] flex flex-col items-start gap-2 bg-[#f5ffff] bg-[linear-gradient(0deg,rgba(245,255,255,1)_0%,rgba(199,216,255,0.3)_100%)] rounded-2xl p-6 '>
          ...
          <div className='drop-shadow-[0_10px_10px_rgba(0,0,0,0.2)] flex flex-col items-start gap-2 bg-[#f7fff7] bg-[linear-gradient(0deg,rgba(247,255,247,1)_0%,rgba(201,255,189,0.4)_100%)] rounded-2xl p-6'>
