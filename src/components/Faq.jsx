  ...
  return (
    <div className="bg-neutral py-16 px-6">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-2xl md:text-4xl font-extrabold text-center text-textdark mb-10">
                ...
                return (
                  ...
                  >
                    <button
                      ...
                      className="flex w-full items-center justify-between p-4 text-left text-base md:text-lg font-medium text-gray-800 hover:bg-textdark/6 cursor-pointer"
                    >
                      {item.q}
                      <ChevronDown
                    ...
                    {isOpen && (
                      <div className="p-4 bg-textdark/6  text-gray-900 text-sm md:text-base">
                        {item.a}
                      </div>
                    )}
                  </div>
